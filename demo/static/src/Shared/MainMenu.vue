<template>
  <div>
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('demo:dashboard')">
        <icon name="dashboard" class="w-4 h-4 mr-2" :class="isUrl('') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'"></icon>
        <div :class="isUrl('') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Dashboard</div>
      </inertia-link>
    </div>
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('demo:organizations')">
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('demo:contacts')">
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('demo:reports')">
