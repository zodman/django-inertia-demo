<template>
  <div>
    ...
    <div class="mb-6 flex justify-between items-center">
      ...
      <inertia-link class="btn-indigo" :href="route('demo:contacts.create')">
        <span>Create</span>
    ...
    <div class="bg-white rounded shadow overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        ...
        <tr v-for="contact in contact_list" :key="contact.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
