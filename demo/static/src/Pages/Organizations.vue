<template>
  <div>
    ...
    <div class="mb-6 flex justify-between items-center">
      ...
      <inertia-link class="btn-indigo" :href="route('demo:organizations.create')">
        <span>Create</span>
    ...
    <div class="bg-white rounded shadow overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        ...
        <tr v-for="organization in organizations.data" :key="organization.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          ...
          <td class="border-t">
            <inertia-link class="px-6 py-4 flex items-center" :href="route('demo:organizations.edit', organization.id)" tabindex="-1">
              {{ organization.city }}
            </inertia-link>
          </td>
          <td class="border-t">
          ...
          <td class="border-t w-px">
            <inertia-link class="px-4 flex items-center" :href="route('demo:organizations.edit', organization.id)" tabindex="-1">
